export async function GET() {
  ...
  const config = {
    accountAssociation: {
      ...
      // payload: "eyJkb21haW4iOiI5MmVkZDVhMGMxZmEubmdyb2suYXBwIn0",
      ...
      // signature: "MHgwMjNkNjA1ZDhmMzUyMGRkNWUzMzQyMDQ4ZTMyMTBiZmNmNmZhNzVmOGQxYzg0OThiNDNhYTI5ZDdlY2E4NjAzMzE0MWQyMzRhODQyYWI4YTRmMmFiNThlYmE5YTEyZTQwODg4NzU4ZDEzOWY2YzZmMTZhYzZkNGEzNzdhNjZjYzFj"
    },
    frame: {
      version: "1",
      name: "FarGuesser",
